		...
		$('#text'+selector).keyup(function(e) {
			...
			if ((e.which === 13 || e.which === 32 || e.which === 17) && trim($(this).val()) !== "") {
				...
				if (block === false && urlRegex.test(text)) {
					...
					$('#previewLoading'+selector).html("<img src='img/loader.gif' />");
